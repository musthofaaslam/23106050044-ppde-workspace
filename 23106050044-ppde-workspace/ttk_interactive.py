...
class InteractiveDashboard:
    def __init__(self):
        """Menginisialisasi aplikasi dashboard dan variabel-variabel data."""
        self.root = tk.Tk()
    ...
    def _setup_styles(self):
        """
        Menyiapkan style ttk untuk tema gelap pada dashboard.
        """
    ...
    def _buat_interface(self):
        """
        Membuat seluruh antarmuka pengguna (UI) dashboard.
        """
        # Main container
    ...
    def _update_time(self):
        """
        Memperbarui label waktu setiap detik.
        """
    ...
    def start_monitoring(self):
        """
        Memulai loop pemantauan dalam thread terpisah.
        """
    ...
    def _monitoring_loop(self):
        """
        Loop utama untuk menghasilkan data simulasi dan memperbarui UI.
        """
        while self.is_running:
            ...
            # Update UI
            # Gunakan after() untuk memperbarui widget dari thread lain
    ...
    def _update_metrics(self):
        """
        Memperbarui label dan progress bar metrik.
        """
    ...
    def _update_chart(self):
        """
        Menambahkan data terbaru ke chart teks ASCII.
        """
    ...
    def clear_data(self):
        """
        Menghapus semua data historis dan mereset UI.
        """
        self.cpu_data.clear()
    ...
    def generate_report(self):
        """
        Membuat dan menampilkan laporan ringkasan data yang dikumpulkan.
        """
        if not self.cpu_data:
            return
